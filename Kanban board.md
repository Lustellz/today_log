...
Today's Done: 이벤트 페이지 기획 및 빌드 준비, 회사 앱 및 웹페이지 프레임워크와 환경 확인

In Progress: 이벤트 페이지 빌드

Tomorrow's Todo: 인터넷 강의로 빌드 환경 공부



## 2020.02.28

Todoay's Done: 마케팅 프로젝트 API 및 로직 분석, 자동이체 등록 완료, 빨래

In Progress: 이벤트 페이지 빌드, 프레임워크 공부, 청소

Tomorrow's Todo: 중고거래, 예산 정립 및 금액 정산, 빨래
...
Today's Done: 설거지, 스터디, 부업1, 빨래, 중고 거래

In Progress: 부업2, 빨래, 청소
...
## 2020.04.27
Today's Done: 행정처리, 생각정리, 청소, 설거지, 부업

In Progress: 기획서 제작, 포트폴리오 정비
